  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='lvshi'"  label="律师账号" prop="lvshizhanghao">
          <el-input v-model="ruleForm.lvshizhanghao" readonly              placeholder="律师账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='lvshi'"  label="律师姓名" prop="lvshixingming">
          <el-input v-model="ruleForm.lvshixingming"               placeholder="律师姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='lvshi'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='lvshi'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
          ...
          @change="lvshizhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='lvshi'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='lvshi'"  label="联系邮箱" prop="lianxiyouxiang">
          <el-input v-model="ruleForm.lianxiyouxiang"               placeholder="联系邮箱" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='lvshi'"  label="律师等级" prop="lvshidengji">
...
export default {
  ...
  methods: {
    lvshizhaopianUploadChange(fileUrls) {
    ...
    onUpdateHandler() {
      ...
      if( 'lvshi' ==this.flag && this.ruleForm.lianxiyouxiang&&(!isEmail(this.ruleForm.lianxiyouxiang))){
