<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="律师等级" prop="lvshidengji">
          <el-select :disabled="ro.lvshidengji" v-model="ruleForm.lvshidengji" placeholder="请选择律师等级">
            <el-option
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `lvshi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.lvshiCrossAddOrUpdateFlag = false;
						 this.parent.search();
