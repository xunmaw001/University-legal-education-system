<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="律师账号" prop="lvshizhanghao">
          <el-input v-model="ruleForm.lvshizhanghao" 
              placeholder="律师账号" clearable  :readonly="ro.lvshizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="律师账号" prop="lvshizhanghao">
              <el-input v-model="ruleForm.lvshizhanghao" 
                placeholder="律师账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="律师姓名" prop="lvshixingming">
          <el-input v-model="ruleForm.lvshixingming" 
              placeholder="律师姓名" clearable  :readonly="ro.lvshixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="律师姓名" prop="lvshixingming">
              <el-input v-model="ruleForm.lvshixingming" 
                placeholder="律师姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="咨询日期" prop="zixunriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zixunriqi" label="咨询日期" prop="zixunriqi">
              <el-input v-model="ruleForm.zixunriqi" 
                placeholder="咨询日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学生" prop="xuesheng">
          <el-input v-model="ruleForm.xuesheng" 
              placeholder="学生" clearable  :readonly="ro.xuesheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学生" prop="xuesheng">
              <el-input v-model="ruleForm.xuesheng" 
                placeholder="学生" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zixunneirong" label="咨询内容" prop="zixunneirong">
                    <span v-html="ruleForm.zixunneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	shouji : false,
      ...
      rules: {
          ...
          zixunriqi: [
                { required: true, message: '咨询日期不能为空', trigger: 'blur' },
          ],
          xuesheng: [
          ],
          xingming: [
  ...
  created() {
	this.ruleForm.zixunriqi = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='lvshizhanghao'){
            this.ruleForm.lvshizhanghao = obj[o];
	    this.ro.lvshizhanghao = true;
            continue;
          }
          if(o=='lvshixingming'){
	    ...
	    this.ro.zixunriqi = true;
          ...
          if(o=='xuesheng'){
            this.ruleForm.xuesheng = obj[o];
	    this.ro.xuesheng = true;
            continue;
          }
          if(o=='xingming'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.xuesheng!=''&&json.xuesheng){
                this.ruleForm.xuesheng = json.xuesheng
	    		this.ro.xuesheng = true;
		}
	...
	this.ruleForm.zixunneirong = this.ruleForm.zixunneirong.replace(reg,'../../../ssmf495f/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zixunwenti/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zixunwentiCrossAddOrUpdateFlag = false;
						 this.parent.search();
