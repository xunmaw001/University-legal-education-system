  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='lvshi'" class="input-group">
			   <div class="label">律师账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.lvshizhanghao" class="input" type="text" placeholder="律师账号">
			   </div>
			 </div> -->
			<el-form-item label="律师账号" class="input" v-if="tableName=='lvshi'">
			  <el-input v-model="ruleForm.lvshizhanghao" autocomplete="off" placeholder="律师账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='lvshi'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='lvshi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='lvshi'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='lvshi'" class="input-group">
			   <div class="label">律师姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.lvshixingming" class="input" type="text" placeholder="律师姓名">
			   </div>
			 </div> -->
			<el-form-item label="律师姓名" class="input" v-if="tableName=='lvshi'">
			  <el-input v-model="ruleForm.lvshixingming" autocomplete="off" placeholder="律师姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='lvshi'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='lvshi'">
			...
			<el-form-item label="联系邮箱" class="input" v-if="tableName=='lvshi'">
			  <el-input v-model="ruleForm.lianxiyouxiang" autocomplete="off" placeholder="联系邮箱"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`lvshi` == this.tableName && this.ruleForm.lianxiyouxiang&&(!this.$validate.isEmail(this.ruleForm.lianxiyouxiang))){
